...
p1=plotIntensityThresholdBySubject(res,subject="S003",
                                         triangular=NULL,displayAFC=FALSE,revertX=FALSE)
...
p2=plotIntensityThresholdBySubject(res2,subject="S003",
                                triangular=NULL,displayAFC=FALSE,revertX=FALSE)+ggtitle("tol=0")
...
plotIntensityThresholdBySubject(res4,subject="S003",
                                triangular=NULL,displayAFC=FALSE)
...
p8=plotIntensityThresholdBySubject(res8,subject="S003",
                                triangular=NULL,displayAFC=FALSE)+ggtitle("tol=0.2,scaleBySubject")
...
p9=plotIntensityThresholdBySubject(res9,subject="S003",
                                triangular=NULL,displayAFC=FALSE)+ggtitle("tol=1")
...
p10=plotIntensityThresholdBySubject(res10,subject="S003",
                                   triangular=NULL,displayAFC=FALSE)+ggtitle("tol=0")

grid.arrange(p10,p8,p9,nrow=1)

res11=getIntensityThreshold(rata2,subjectName="Paneliste",decreasingConcentrations=c("C9","C8","C7","C6","C5","C4","C3","C2","C1"),decreasingNumConcentrations=9:1,minConc=0,maxConc=10,tol=0)
p11=plotIntensityThresholdBySubject(res11,subject="S003",
                                    triangular=triangular,displayAFC=FALSE)+ggtitle("tol=0")
p11
